...
export default function ParkingDetails() {
  ...
  const space: ParkingSpace | undefined = state?.space;
  ...
  const sid = space._id && typeof space._id === 'object' && space._id.toString ? space._id.toString() : space._id;
      ...
      <div className="max-w-xl mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="w-full h-48 relative">
            <img
              src={space.imageUrl || "https://plus.unsplash.com/premium_photo-1673886205989-24c637783c60?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}
              alt={space.title}
          ...
          <div className="p-4">
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center text-gray-600">
                ...
                <p className="text-sm">{street}, {city}, {stateName}, {country} - {zipCode}</p>
              </div>
            </div>
            ...
            <div className="flex items-center text-gray-600 mt-2">
              ...
              <span className="text-sm">{space.distance.toFixed(2)} km away</span>
            </div>
            ...
            {/* {space.availability && space.availability.length > 0 && (
              <div className="mt-4">
                ...
                <ul className="text-xs text-gray-600">
                  {space.availability.map((slots, index) => (
                    <li key={index} className="bg-gray-50 rounded p-2 mb-1">
